...
- (void)setupBottomView
{
    ...
    NSString * hit = [NSString stringWithFormat:@"最多%ld张图片%@" ,(long)nav.maxSelectCount,(nav.allowSelectVideo ? @"或视频" : @"")];
    UILabel * label = [[UILabel alloc] initWithFrame:CGRectMake(12, 7, GetMatchValue(hit, 18, YES, 30), 30)];
    [label setText:hit];
