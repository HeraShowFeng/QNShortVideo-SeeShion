...
public class AlbumsSpinner {
    ...
    public AlbumsSpinner(@NonNull Context context) {
        ...
        mListPopupWindow.setContentWidth((int) (160 * density));
        mListPopupWindow.setHorizontalOffset((int) (16 * density));
        //mListPopupWindow.setVerticalOffset((int) (-48 * density));
        //mListPopupWindow.setBackgroundDrawable(new ColorDrawable(context.getResources().getColor(R.color.normal_black)));
