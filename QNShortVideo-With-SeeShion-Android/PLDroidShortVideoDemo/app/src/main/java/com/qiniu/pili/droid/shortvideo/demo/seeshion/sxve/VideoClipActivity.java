...
import com.qiniu.pili.droid.shortvideo.demo.seeshion.sxve.adapter.TimelineAdapter;
import com.qiniu.pili.droid.shortvideo.demo.seeshion.sxve.view.SXProgressDialog;
import com.qiniu.pili.droid.shortvideo.demo.seeshion.sxve.view.SXVideoView;
import com.qiniu.pili.droid.shortvideo.demo.seeshion.sxve.view.VideoClipLayout;
...
public class VideoClipActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, CompoundButton.OnCheckedChangeListener, SXVideoView.OnGetSizeListener {
    ...
    public void next(View view) {
        ...
        SXCompositor formatter = new SXCompositor(mVideoPath, outputPath, matrix, mVideoView.isMute());
