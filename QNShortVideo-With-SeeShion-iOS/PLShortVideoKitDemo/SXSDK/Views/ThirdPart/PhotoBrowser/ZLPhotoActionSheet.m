...
@property (nonatomic, strong) UIButton *btnAblum;
@property (nonatomic, strong) UIButton *btnCancel;
@property (nonatomic, strong) UIView *baseView;
@property (nonatomic, strong) UICollectionView *collectionView;
@property (nonatomic, strong) NSLayoutConstraint *verColHeight;
@property (nonatomic, strong) NSLayoutConstraint *verBottomSpace;
...
//    __block NSMutableArray *paths = [NSMutableArray arrayWithCapacity:data.count];
...
//        [paths addObject:@""];
    ...
    for (int i = 0; i < data.count; i++) {
        ...
        [ZLPhotoManager requestSelectedImageForAsset:model isOriginal:self.isSelectOriginalPhoto allowSelectGif:self.allowSelectGif completion:^(UIImage *image, NSDictionary *info) {
            ...
            zl_strongify(weakSelf);
            if (image) {
                [photos replaceObjectAtIndex:i withObject:[ZLPhotoManager scaleImage:image original:strongSelf->_isSelectOriginalPhoto || model.asset.mediaType == PHAssetMediaTypeVideo]];
                [assets replaceObjectAtIndex:i withObject:model.asset];
//                [paths replaceObjectAtIndex:i withObject:[model.url absoluteString]];
            }
