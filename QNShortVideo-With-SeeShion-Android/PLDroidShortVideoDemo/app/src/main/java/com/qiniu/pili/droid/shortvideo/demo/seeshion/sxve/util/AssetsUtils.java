package com.qiniu.pili.droid.shortvideo.demo.seeshion.sxve.util;
        ...
        try {
            ...
            if (names.length > 0) {
                ...
                for (String name : names) {
                    copyDirFromAssets(context, src.equals("") ? name : src + File.separator + name, dest + File.separator + name);
                }
            } else {
