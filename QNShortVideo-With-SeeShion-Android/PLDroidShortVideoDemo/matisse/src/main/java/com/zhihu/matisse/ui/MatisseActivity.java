...
public class MatisseActivity extends AppCompatActivity implements
    ...
    public void selectPics(List<Uri> uriData, List<String> stringData) {
        Intent result = new Intent();
        ArrayList<Uri> selectedUris = (ArrayList<Uri>) uriData;
        result.putParcelableArrayListExtra(EXTRA_RESULT_SELECTION, selectedUris);
        ArrayList<String> selectedPaths = (ArrayList<String>) stringData;
        result.putStringArrayListExtra(EXTRA_RESULT_SELECTION_PATH, selectedPaths);
        result.putExtra(EXTRA_RESULT_ORIGINAL_ENABLE, mOriginalEnable);
        setResult(RESULT_OK, result);
        finish();
    ...
    public void selectPics() {
        if (!isOverMinSelectable()) {
            Toast.makeText(
                    ...
                    String.format(getResources().getString(R.string.min_tips),mSpec.minSelectable),
                    Toast.LENGTH_SHORT)
                    .show();
            return;
        }
    ...
    private boolean isOverMinSelectable() {
        return mSelectedCollection.asList().size() >= mSpec.minSelectable;
    }
}
