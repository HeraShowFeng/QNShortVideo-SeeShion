...
public final class SelectionCreator {
    ...
    public SelectionCreator maxSelectable(int maxSelectable) {
        ...
        if (maxSelectable < mSelectionSpec.minSelectable) {
    ...
    //设置是否能查看大图
    public SelectionCreator picDetail(boolean isPicDetail) {
        mSelectionSpec.picDetail = isPicDetail;
        return this;
    }
